...
function CartItem({ item }: CartItemProps) {
  ...
  return (
    <div className="flex items-center gap-4 border-b border-gray-100 py-5 last:border-b-0 dark:border-gray-800">
      <div className="flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-lg border border-gray-100 bg-white p-2 dark:border-gray-800 dark:bg-gray-950">
        <img
          src={product.image}
          alt={product.title}
          className="h-full w-full object-contain"
      ...
      <p className="w-20 flex-shrink-0 text-right font-semibold text-ink-900 dark:text-ink-dark">
        ${(product.price * quantity).toFixed(2)}
      </p>
